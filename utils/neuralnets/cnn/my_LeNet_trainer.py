...
class MyLeNet_trainer():
    ...
    def batch_train_data(self,batch_size=256,shuffle=True):
        ...
        #############################################################
        # TODO: create augumented data with 
        # translate(2,0)
        # add_noise(1,10)
        # flip('v')
        #############################################################
        train_data_translate = train_data.translate(2,0)
        train_data_noise = train_data.add_noise(1,10)
        train_data_flip = train_data.flip('v')
        return train_data_translate, train_data_noise, train_data_flip
