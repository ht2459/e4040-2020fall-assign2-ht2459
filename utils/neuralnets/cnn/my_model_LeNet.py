...
class LeNet(Model):
    ...
    def __init__(self, input_shape, output_size=10):
        ...
        #############################################################
        self.conv_layer_1 = Conv2D(filters=6, kernel_size=(3, 3), strides=(1,1), activation='tanh', input_shape=input_shape, padding="same")
        self.avgpool_layer_1 = AveragePooling2D(pool_size=(2, 2), strides=(2, 2), padding='valid')
        self.dropout = Dropout(0.2)
        self.conv_layer_2 = Conv2D(filters=16, kernel_size=(3, 3), strides=(1,1), activation='tanh', input_shape=input_shape, padding="same")
        self.avgpool_layer_2 = AveragePooling2D(pool_size=(2, 2), strides=(2, 2), padding='valid')
        
        self.flatten_layer = Flatten()
        self.fc_layer_1 = Dense(120, activation='tanh')
        self.fc_layer_2 = Dense(84, activation='tanh')
